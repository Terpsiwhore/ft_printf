...
PRS_SRC		= ft_parse_flags.c	ft_parse_precision.c	ft_parse_type.c		   \
			  ft_parse_width.c	ft_parser.c
PRS_OBJ		= $(addprefix $(OBJ_DIR), $(PRS_SRC:.c=.o))
#-------------------------------------------------------------------------------
COR_DIR		= core/
COR_HDR		= $(addprefix $(HDR_DIR), ft_core.h)
COR_SRC		= ft_core.c			ft_core_type_c.c		ft_core_type_i.c	   \
			  ft_core_type_p.c	ft_core_type_pc.c		ft_core_type_s.c	   \
			  ft_core_type_u.c		ft_core_type_x.c	ft_core_type_n.c
